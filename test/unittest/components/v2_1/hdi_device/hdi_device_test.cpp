...
namespace mindspore {
namespace lite {
OHOS::HDI::Nnrt::V2_1::Model* MindIR_LiteGraph_To_Model(const LiteGraph* lite_graph,
    const OHOS::HDI::Nnrt::V2_1::SharedBuffer& buffer)
{
    return new (std::nothrow) OHOS::HDI::Nnrt::V2_1::Model();
}

void MindIR_Model_Destroy(OHOS::HDI::Nnrt::V2_1::Model** model)
{
