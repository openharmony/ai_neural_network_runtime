 ...
 * @tc.type: FUNC
 */
HWTEST_F(GreaterEqualBuilderTest, greaterEqual_build_001, TestSize.Level0)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(GreaterEqualBuilderTest, greaterEqual_build_002, TestSize.Level0)
{
    SaveInputTensor(m_inputs, OH_NN_INT32, m_inputDim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_BOOL, m_outputDim, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(GreaterEqualBuilderTest, greaterEqual_build_003, TestSize.Level0)
{
    m_inputs = {0, 1, 2, 3};
    m_outputs = {4};
 ...
 * @tc.type: FUNC
 */
HWTEST_F(GreaterEqualBuilderTest, greaterEqual_build_004, TestSize.Level0)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(GreaterEqualBuilderTest, greaterEqual_build_005, TestSize.Level0)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(GreaterEqualBuilderTest, greaterEqual_build_006, TestSize.Level0)
{
    SaveInputTensor(m_inputs, OH_NN_INT32, m_inputDim, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(GreaterEqualBuilderTest, greaterEqual_build_007, TestSize.Level0)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(GreaterEqualBuilderTest, greaterEqual_getprimitive_001, TestSize.Level0)
{
    SaveInputTensor(m_inputs, OH_NN_INT32, m_inputDim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_BOOL, m_outputDim, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(GreaterEqualBuilderTest, greaterEqual_getprimitive_002, TestSize.Level0)
{
    LiteGraphPrimitvePtr primitive = m_builder.GetPrimitive();
    LiteGraphPrimitvePtr expectPrimitive(nullptr, DestroyLiteGraphPrimitive);
