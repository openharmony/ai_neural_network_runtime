...
#include "ops/reducemax_builder.h"
...
namespace UnitTest {
class ReduceMaxBuilderTest : public OpsTest {
public:
    void SetUp() override;
...
void ReduceMaxBuilderTest::SetUp() {}

void ReduceMaxBuilderTest::TearDown() {}

void ReduceMaxBuilderTest::SetKeepDims(OH_NN_DataType dataType,
    const std::vector<int32_t> &dim, const OH_NN_QuantParam* quantParam, OH_NN_TensorType type)
{
...
void ReduceMaxBuilderTest::SetCoeff(OH_NN_DataType dataType,
    const std::vector<int32_t> &dim, const OH_NN_QuantParam* quantParam, OH_NN_TensorType type)
{
...
void ReduceMaxBuilderTest::SetReduceToEnd(OH_NN_DataType dataType,
    const std::vector<int32_t> &dim, const OH_NN_QuantParam* quantParam, OH_NN_TensorType type)
{
...
/**
 * @tc.name: reducemax_build_002
 * @tc.desc: Call Build func twice to verify the abnormal behavior of the Build function
 * @tc.type: FUNC
 */
HWTEST_F(ReduceMaxBuilderTest, reducemax_build_002, TestSize.Level0)
{
    SaveInputTensor(m_inputs, OH_NN_BOOL, m_inputDim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_BOOL, m_outputDim, nullptr);
    SetKeepDims(OH_NN_BOOL, m_paramDim, nullptr, OH_NN_REDUCE_MAX_KEEP_DIMS);
...
/**
 * @tc.name: reducemax_build_005
 * @tc.desc: Verify that the build function return a failed message with null allTensor
 * @tc.type: FUNC
 */
HWTEST_F(ReduceMaxBuilderTest, reducemax_build_005, TestSize.Level0)
{
...
/**
 * @tc.name: reducemax_build_006
 * @tc.desc: Verify that the build function return a failed message without output tensor
 * @tc.type: FUNC
 */
HWTEST_F(ReduceMaxBuilderTest, reducemax_build_006, TestSize.Level0)
{
    SaveInputTensor(m_inputs, OH_NN_BOOL, m_inputDim, nullptr);
...
HWTEST_F(ReduceMaxBuilderTest, reducemax_build_009, TestSize.Level0)
{
    ...
    std::shared_ptr<NNTensor> reduceToEndTensor = TransToNNTensor(OH_NN_INT64,
        m_paramDim, nullptr, OH_NN_REDUCE_MAX_REDUCE_TO_END);
...
/**
 * @tc.name: reducemax_build_016
 * @tc.desc: Verify that the build function return a failed message with empty keepdims's buffer
 * @tc.type: FUNC
 */
HWTEST_F(ReduceMaxBuilderTest, reducemax_build_016, TestSize.Level0)
{
    SaveInputTensor(m_inputs, OH_NN_BOOL, m_inputDim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_BOOL, m_outputDim, nullptr);
...
/**
 * @tc.name: reducemax_build_017
 * @tc.desc: Verify that the build function return a failed message with empty coeff's buffer
 * @tc.type: FUNC
 */
HWTEST_F(ReduceMaxBuilderTest, reducemax_build_017, TestSize.Level0)
{
    SaveInputTensor(m_inputs, OH_NN_BOOL, m_inputDim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_BOOL, m_outputDim, nullptr);
...
/**
 * @tc.name: reducemax_get_primitive_001
 * @tc.desc: Verify the GetPrimitive function return nullptr
 * @tc.type: FUNC
 */
HWTEST_F(ReduceMaxBuilderTest, reducemax_get_primitive_001, TestSize.Level0)
{
...
/**
 * @tc.name: reducemax_get_primitive_002
 * @tc.desc: Verify the normal params return behavior of the getprimitive function
 * @tc.type: FUNC
 */
HWTEST_F(ReduceMaxBuilderTest, reducemax_get_primitive_002, TestSize.Level0)
{
    SaveInputTensor(m_inputs, OH_NN_BOOL, m_inputDim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_BOOL, m_outputDim, nullptr);
    SetKeepDims(OH_NN_BOOL, m_paramDim, nullptr, OH_NN_REDUCE_MAX_KEEP_DIMS);
    ...
    EXPECT_EQ(OH_NN_SUCCESS, m_builder.Build(m_params, m_inputsIndex, m_outputsIndex, m_allTensors));
    LiteGraphTensorPtr reducemaxPrimitive = m_builder.GetPrimitive();
    LiteGraphTensorPtr expectPrimitive = {nullptr, DestroyLiteGraphPrimitive};

    EXPECT_NE(reducemaxPrimitive, expectPrimitive);
    auto returnKeepDimsValue = mindspore::lite::MindIR_ReduceFusion_GetKeepDims(reducemaxPrimitive.get());
    EXPECT_EQ(returnKeepDimsValue, keepDimsValue);
    auto returnCoeffValue = mindspore::lite::MindIR_ReduceFusion_GetCoeff(reducemaxPrimitive.get());
    EXPECT_EQ(returnCoeffValue, coeffValue);
    auto returnReduceToEndValue = mindspore::lite::MindIR_ReduceFusion_GetReduceToEnd(reducemaxPrimitive.get());
