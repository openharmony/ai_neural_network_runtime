...
#include "ops/hard_sigmoid_builder.h"
...
namespace UnitTest {
class HardSigmoidBuilderTest : public OpsTest {
public:
    void SetUp() override;
    void TearDown() override;

protected:
    HardSigmoidBuilder m_builder;
...
void HardSigmoidBuilderTest::SetUp() {}

void HardSigmoidBuilderTest::TearDown() {}

/**
 * @tc.name: hardSigmoid_build_001
 * @tc.desc: Verify that the build function returns a successful message.
 * @tc.type: FUNC
 */
HWTEST_F(HardSigmoidBuilderTest, hardSigmoid_build_001, TestSize.Level0)
{
...
/**
 * @tc.name: hardSigmoid_build_002
 * @tc.desc: Verify that the build function returns a failed message with true m_isBuild.
 * @tc.type: FUNC
 */
HWTEST_F(HardSigmoidBuilderTest, hardSigmoid_build_002, TestSize.Level0)
{
    SaveInputTensor(m_inputs, OH_NN_FLOAT32, m_inputDim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_FLOAT32, m_outputDim, nullptr);
...
/**
 * @tc.name: hardSigmoid_build_003
 * @tc.desc: Verify that the build function returns a failed message with invalided input.
 * @tc.type: FUNC
 */
HWTEST_F(HardSigmoidBuilderTest, hardSigmoid_build_003, TestSize.Level0)
{
    m_inputs = {0, 1};
    m_outputs = {2};
...
/**
 * @tc.name: hardSigmoid_build_004
 * @tc.desc: Verify that the build function returns a failed message with invalided output.
 * @tc.type: FUNC
 */
HWTEST_F(HardSigmoidBuilderTest, hardSigmoid_build_004, TestSize.Level0)
{
...
/**
 * @tc.name: hardSigmoid_build_005
 * @tc.desc: Verify that the build function returns a failed message with empty allTensor.
 * @tc.type: FUNC
 */
HWTEST_F(HardSigmoidBuilderTest, hardSigmoid_build_005, TestSize.Level0)
{
...
/**
 * @tc.name: hardSigmoid_build_006
 * @tc.desc: Verify that the build function returns a failed message without output tensor.
 * @tc.type: FUNC
 */
HWTEST_F(HardSigmoidBuilderTest, hardSigmoid_build_006, TestSize.Level0)
{
    SaveInputTensor(m_inputs, OH_NN_FLOAT32, m_inputDim, nullptr);
...
/**
 * @tc.name: hardSigmoid_build_007
 * @tc.desc: Verify that the build function returns a failed message with a virtual parameter.
 * @tc.type: FUNC
 */
HWTEST_F(HardSigmoidBuilderTest, hardSigmoid_build_007, TestSize.Level0)
{
...
/**
 * @tc.name: hardSigmoid_getprimitive_001
 * @tc.desc: Verify that the getPrimitive function returns a successful message
 * @tc.type: FUNC
 */
HWTEST_F(HardSigmoidBuilderTest, hardSigmoid_getprimitive_001, TestSize.Level0)
{
    SaveInputTensor(m_inputs, OH_NN_FLOAT32, m_inputDim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_FLOAT32, m_outputDim, nullptr);
...
/**
 * @tc.name: hardSigmoid_getprimitive_002
 * @tc.desc: Verify that the getPrimitive function returns a failed message without build.
 * @tc.type: FUNC
 */
HWTEST_F(HardSigmoidBuilderTest, hardSigmoid_getprimitive_002, TestSize.Level0)
{
    LiteGraphPrimitvePtr primitive = m_builder.GetPrimitive();
    LiteGraphPrimitvePtr expectPrimitive(nullptr, DestroyLiteGraphPrimitive);
