 ...
 * @tc.type: FUNC
 */
HWTEST_F(LogicalNotBuilderTest, logical_not_build_001, TestSize.Level2)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(LogicalNotBuilderTest, logical_not_build_002, TestSize.Level2)
{
    SaveInputTensor(m_inputs, OH_NN_INT32, m_dim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_INT32, m_dim, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(LogicalNotBuilderTest, logical_not_build_003, TestSize.Level2)
{
    m_inputs = {0, 1};
    m_outputs = {2};
 ...
 * @tc.type: FUNC
 */
HWTEST_F(LogicalNotBuilderTest, logical_not_build_004, TestSize.Level2)
{
    m_outputs = {1, 2};
 ...
 * @tc.type: FUNC
 */
HWTEST_F(LogicalNotBuilderTest, logical_not_build_005, TestSize.Level2)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(LogicalNotBuilderTest, logical_not_build_006, TestSize.Level2)
{
    SaveInputTensor(m_inputs, OH_NN_INT32, m_dim, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(LogicalNotBuilderTest, logical_not_getprimitive_001, TestSize.Level2)
{
    SaveInputTensor(m_inputs, OH_NN_INT32, m_dim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_INT32, m_dim, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(LogicalNotBuilderTest, logical_not_getprimitive_002, TestSize.Level2)
{
    LiteGraphPrimitvePtr primitive = m_builder.GetPrimitive();
    LiteGraphPrimitvePtr expectPrimitive(nullptr, DestroyLiteGraphPrimitive);
