...
#include "ops/normalize_builder.h"
...
namespace UnitTest {
class NormalizeBuilderTest : public OpsTest {
public:
    void SetUp() override;
    void TearDown() override;

protected:
    NormalizeBuilder m_builder;
    std::vector<uint32_t> m_inputs {0};
    std::vector<uint32_t> m_outputs {1};
    std::vector<int32_t> m_dim {1, 2, 2, 1};
};

void NormalizeBuilderTest::SetUp() {}

void NormalizeBuilderTest::TearDown() {}

/**
 * @tc.name: normalize_build_001
 * @tc.desc: Verify that the build function returns a successful message.
 * @tc.type: FUNC
 */
HWTEST_F(NormalizeBuilderTest, normalize_build_001, TestSize.Level2)
{
...
/**
 * @tc.name: normalize_build_002
 * @tc.desc: Verify that the build function returns a failed message with true m_isBuild.
 * @tc.type: FUNC
 */
HWTEST_F(NormalizeBuilderTest, normalize_build_002, TestSize.Level2)
{
    SaveInputTensor(m_inputs, OH_NN_INT32, m_dim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_INT32, m_dim, nullptr);
...
/**
 * @tc.name: normalize_build_003
 * @tc.desc: Verify that the build function returns a failed message with invalided input.
 * @tc.type: FUNC
 */
HWTEST_F(NormalizeBuilderTest, normalize_build_003, TestSize.Level2)
{
    m_inputs = {0, 1};
    m_outputs = {2};
...
/**
 * @tc.name: normalize_build_004
 * @tc.desc: Verify that the build function returns a failed message with invalided output.
 * @tc.type: FUNC
 */
HWTEST_F(NormalizeBuilderTest, normalize_build_004, TestSize.Level2)
{
    m_outputs = {1, 2};
...
/**
 * @tc.name: normalize_build_005
 * @tc.desc: Verify that the build function returns a failed message with empty allTensor.
 * @tc.type: FUNC
 */
HWTEST_F(NormalizeBuilderTest, normalize_build_005, TestSize.Level2)
{
...
/**
 * @tc.name: normalize_build_006
 * @tc.desc: Verify that the build function returns a failed message without output tensor.
 * @tc.type: FUNC
 */
HWTEST_F(NormalizeBuilderTest, normalize_build_006, TestSize.Level2)
{
    SaveInputTensor(m_inputs, OH_NN_INT32, m_dim, nullptr);
...
/**
 * @tc.name: normalize_getprimitive_001
 * @tc.desc: Verify that the getPrimitive function returns a successful message
 * @tc.type: FUNC
 */
HWTEST_F(NormalizeBuilderTest, normalize_getprimitive_001, TestSize.Level2)
{
    SaveInputTensor(m_inputs, OH_NN_INT32, m_dim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_INT32, m_dim, nullptr);
...
/**
 * @tc.name: normalize_getprimitive_002
 * @tc.desc: Verify that the getPrimitive function returns a failed message without build.
 * @tc.type: FUNC
 */
HWTEST_F(NormalizeBuilderTest, normalize_getprimitive_002, TestSize.Level2)
{
    LiteGraphPrimitvePtr primitive = m_builder.GetPrimitive();
    LiteGraphPrimitvePtr expectPrimitive(nullptr, DestroyLiteGraphPrimitive);
