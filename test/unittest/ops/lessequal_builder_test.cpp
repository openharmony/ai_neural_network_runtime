...
#include "ops/lessequal_builder.h"
 ...
 * @tc.type: FUNC
 */
HWTEST_F(LessEqualBuilderTest, lessequal_build_001, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(LessEqualBuilderTest, lessequal_build_002, TestSize.Level1)
{
    SaveInputTensor(m_inputs, OH_NN_INT32, m_inputDim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_BOOL, m_outputDim, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(LessEqualBuilderTest, lessequal_build_003, TestSize.Level1)
{
    m_inputs = {0, 1, 2, 3};
    m_outputs = {4};
 ...
 * @tc.type: FUNC
 */
HWTEST_F(LessEqualBuilderTest, lessequal_build_004, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(LessEqualBuilderTest, lessequal_build_005, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(LessEqualBuilderTest, lessequal_build_006, TestSize.Level1)
{
    SaveInputTensor(m_inputs, OH_NN_INT32, m_inputDim, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(LessEqualBuilderTest, lessequal_build_007, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(LessEqualBuilderTest, lessequal_getprimitive_001, TestSize.Level1)
{
    SaveInputTensor(m_inputs, OH_NN_INT32, m_inputDim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_BOOL, m_outputDim, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(LessEqualBuilderTest, lessequal_getprimitive_002, TestSize.Level1)
{
