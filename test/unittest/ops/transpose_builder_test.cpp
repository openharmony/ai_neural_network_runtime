...
#include "frameworks/native/ops/transpose_builder.h"
...
namespace UnitTest {
class TransposeBuilderTest : public OpsTest {
protected:
    void InitTensor(const std::vector<uint32_t>& inputsIndex,
        const std::vector<uint32_t>& outputsIndex) override;

protected:
    TransposeBuilder m_builder;
};

void TransposeBuilderTest::InitTensor(const std::vector<uint32_t>& inputsIndex,
    const std::vector<uint32_t>& outputsIndex)
{
    std::vector<int32_t> inputDim = {2, 3};
...
/**
 * @tc.name: transpose_build_001
 * @tc.desc: Provide normal input, output to verify the normal behavior of the Build function
 * @tc.type: FUNC
 */
HWTEST_F(TransposeBuilderTest, transpose_build_001, TestSize.Level0)
{
...
/**
 * @tc.name: transpose_build_002
 * @tc.desc: Call Build func twice to verify the abnormal behavior of the Build function
 * @tc.type: FUNC
 */
HWTEST_F(TransposeBuilderTest, transpose_build_002, TestSize.Level0)
{
    std::vector<uint32_t> inputsIndex = { 0, 1 };
    std::vector<uint32_t> outputsIndex = { 2 };
...
/**
 * @tc.name: transpose_build_006
 * @tc.desc: Provide empty output to verify the abnormal behavior of the Build function
 * @tc.type: FUNC
 */
HWTEST_F(TransposeBuilderTest, transpose_build_006, TestSize.Level0)
{
    std::vector<uint32_t> inputsIndex = { 0, 1 };
...
/**
 * @tc.name: transpose_build_007
 * @tc.desc: Provide a param to verify the abnormal behavior of the Build function
 * @tc.type: FUNC
 */
HWTEST_F(TransposeBuilderTest, transpose_build_007, TestSize.Level0)
{
    std::vector<uint32_t> inputsIndex = { 0, 1 };
    std::vector<uint32_t> outputsIndex = { 2 };
...
/**
 * @tc.name: transpose_get_primitive_001
 * @tc.desc: Verify the GetPrimitive function return nullptr
 * @tc.type: FUNC
 */
HWTEST_F(TransposeBuilderTest, transpose_get_primitive_001, TestSize.Level0)
{
...
/**
 * @tc.name: transpose_getprimitive_002
 * @tc.desc: Verify the normal return behavior of the getprimitive function
 * @tc.type: FUNC
 */
HWTEST_F(TransposeBuilderTest, transpose_getprimitive_002, TestSize.Level0)
{
    std::vector<uint32_t> inputsIndex = { 0, 1 };
    std::vector<uint32_t> outputsIndex = { 2 };
