...
#include "frameworks/native/ops/tanh_builder.h"
...
namespace UnitTest {
class TanhBuilderTest : public OpsTest {
protected:
    void InitTensor(const std::vector<uint32_t>& inputsIndex,
        const std::vector<uint32_t>& outputsIndex) override;

protected:
    TanhBuilder m_builder;
};

void TanhBuilderTest::InitTensor(const std::vector<uint32_t>& inputsIndex,
...
/**
 * @tc.name: tanh_build_007
 * @tc.desc: Provide a param to verify the abnormal behavior of the Build function
 * @tc.type: FUNC
 */
HWTEST_F(TanhBuilderTest, tanh_build_007, TestSize.Level0)
{
    std::vector<uint32_t> inputsIndex = { 0 };
    std::vector<uint32_t> outputsIndex = { 1 };
...
/**
 * @tc.name: tanh_get_primitive_001
 * @tc.desc: Verify the GetPrimitive function return nullptr
 * @tc.type: FUNC
 */
HWTEST_F(TanhBuilderTest, tanh_get_primitive_001, TestSize.Level0)
{
...
/**
 * @tc.name: tanh_get_primitive_002
 * @tc.desc: Verify the normal params return behavior of the getprimitive function
 * @tc.type: FUNC
 */
HWTEST_F(TanhBuilderTest, tanh_get_primitive_002, TestSize.Level0)
{
    std::vector<uint32_t> inputsIndex = { 0 };
    std::vector<uint32_t> outputsIndex = { 1 };
