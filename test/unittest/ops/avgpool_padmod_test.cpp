...
#include "frameworks/native/ops/avgpool_builder.h"
...
namespace UnitTest {
class AvgPoolBuilderTest : public OpsTest {
public:
    void SetUp() override;
...
void AvgPoolBuilderTest::SetParams()
{
...
/**
 * @tc.name: avgpool_build_pad_mode_001
 * @tc.desc: Verify the success of the build function
 * @tc.type: FUNC
 */
HWTEST_F(AvgPoolBuilderTest, avgpool_build_pad_mode_001, TestSize.Level1)
{
...
/**
 * @tc.name: avgpool_build_pad_mode_002
 * @tc.desc: Verify the forbidden of the build function
 * @tc.type: FUNC
 */
HWTEST_F(AvgPoolBuilderTest, avgpool_build_pad_mode_002, TestSize.Level1)
{
    m_paramsIndex = m_params;
    SaveInputTensor(m_inputs, OH_NN_FLOAT32, m_input_dim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_FLOAT32, m_output_dim, nullptr);
...
/**
 * @tc.name: avgpool_build_pad_mode_003
 * @tc.desc: Verify the missing input of the build function
 * @tc.type: FUNC
 */
HWTEST_F(AvgPoolBuilderTest, avgpool_build_pad_mode_003, TestSize.Level1)
{
    m_inputs = {};
    m_outputs = {0};
    m_params = {1, 2, 3, 4};
...
/**
 * @tc.name: avgpool_build_pad_mode_004
 * @tc.desc: Verify the missing output of the build function
 * @tc.type: FUNC
 */
HWTEST_F(AvgPoolBuilderTest, avgpool_build_pad_mode_004, TestSize.Level1)
{
    m_inputs = {0};
    m_outputs = {};
    m_params = {1, 2, 3, 4};
...
/**
 * @tc.name: avgpool_build_pad_mode_005
...
/**
 * @tc.name: avgpool_build_pad_mode_007
 * @tc.desc: Verify the invalid kernelSize of the build function
 * @tc.type: FUNC
 */
HWTEST_F(AvgPoolBuilderTest, avgpool_build_pad_mode_007, TestSize.Level1)
{
    m_paramsIndex = m_params;
    SaveInputTensor(m_inputs, OH_NN_FLOAT32, m_input_dim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_FLOAT32, m_output_dim, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(AvgPoolBuilderTest, avgpool_build_pad_mode_008, TestSize.Level1)
{
    m_paramsIndex = m_params;
    SaveInputTensor(m_inputs, OH_NN_FLOAT32, m_input_dim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_FLOAT32, m_output_dim, nullptr);
...
/**
 * @tc.name: avgpool_build_pad_mode_009
 * @tc.desc: Verify the invalid padmode of the build function
 * @tc.type: FUNC
 */
HWTEST_F(AvgPoolBuilderTest, avgpool_build_pad_mode_009, TestSize.Level1)
{
    m_paramsIndex = m_params;
    SaveInputTensor(m_inputs, OH_NN_FLOAT32, m_input_dim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_FLOAT32, m_output_dim, nullptr);
    ...
    std::shared_ptr<NNTensor> tensor = TransToNNTensor(OH_NN_INT32, m_param_dim, nullptr, OH_NN_AVG_POOL_PAD_MODE);
...
/**
 * @tc.name: avgpool_build_pad_mode_010
 * @tc.desc: Verify the invalid activation type of the build function
 * @tc.type: FUNC
 */
HWTEST_F(AvgPoolBuilderTest, avgpool_build_pad_mode_010, TestSize.Level1)
{
    m_paramsIndex = m_params;
    SaveInputTensor(m_inputs, OH_NN_FLOAT32, m_input_dim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_FLOAT32, m_output_dim, nullptr);
...
HWTEST_F(AvgPoolBuilderTest, avgpool_build_pad_mode_013, TestSize.Level1)
{
    ...
    SetKernelSize(OH_NN_INT64, m_kenelsize_dim, nullptr, OH_NN_AVG_POOL_KERNEL_SIZE);
    SetStride(OH_NN_INT64, m_stride_dim, nullptr, OH_NN_AVG_POOL_STRIDE);
    int8_t *padValueTest = new (std::nothrow) int8_t(6);
    EXPECT_NE(nullptr, padValueTest);

    std::shared_ptr<NNTensor> tensor = TransToNNTensor(OH_NN_INT8, m_param_dim, nullptr, OH_NN_AVG_POOL_PAD_MODE);
    tensor->SetBuffer(padValueTest, sizeof(int8_t));
    m_allTensors.emplace_back(tensor);
    SetActivation(OH_NN_INT8, m_param_dim, nullptr, OH_NN_AVG_POOL_ACTIVATION_TYPE);
    EXPECT_EQ(OH_NN_INVALID_PARAMETER, m_builder.Build(m_paramsIndex, m_inputsIndex, m_outputsIndex, m_allTensors));
}
...
HWTEST_F(AvgPoolBuilderTest, avgpool_build_pad_mode_014, TestSize.Level1)
{
    ...
    int8_t* activationValue = new (std::nothrow) int8_t(6);
    EXPECT_NE(nullptr, activationValue);
    std::shared_ptr<NNTensor> tensor = TransToNNTensor(OH_NN_INT8, m_param_dim, nullptr,
        OH_NN_AVG_POOL_ACTIVATION_TYPE);
    tensor->SetBuffer(activationValue, sizeof(int8_t));
 ...
 * @tc.type: FUNC
 */
HWTEST_F(AvgPoolBuilderTest, avgpool_getprimitive_pad_mode_001, TestSize.Level1)
{
    m_paramsIndex = m_params;
    SaveInputTensor(m_inputs, OH_NN_FLOAT32, m_input_dim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_FLOAT32, m_output_dim, nullptr);
    ...
    std::vector<int64_t> returnKernelSize = mindspore::lite::MindIR_AvgPoolFusion_GetKernelSize(primitive.get());
    std::vector<int64_t> kernelSizeValueTest{1, 1};
    EXPECT_EQ(kernelSizeValueTest, returnKernelSize);

    std::vector<int64_t> returnStrides = mindspore::lite::MindIR_AvgPoolFusion_GetStrides(primitive.get());
    std::vector<int64_t> strideValueTest{1, 1};
    int returnPadMode = mindspore::lite::MindIR_AvgPoolFusion_GetPadMode(primitive.get());
...
/**
 * @tc.name: avgpool_getprimitive_pad_mode_002
 * @tc.desc: Verify the behavior of the GetPrimitive function
 * @tc.type: FUNC
 */
HWTEST_F(AvgPoolBuilderTest, avgpool_getprimitive_pad_mode_002, TestSize.Level1)
{
    m_paramsIndex = m_params;
    SaveInputTensor(m_inputs, OH_NN_FLOAT32, m_input_dim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_FLOAT32, m_output_dim, nullptr);
