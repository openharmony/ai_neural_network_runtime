...
#include "ops/scatter_nd_builder.h"
...
namespace UnitTest {
class ScatterNDBuilderTest : public OpsTest {
public:
    void SetUp() override;
    void TearDown() override;

protected:
    ScatterNDBuilder m_builder;
    std::vector<uint32_t> m_inputs {0, 1, 2};
    std::vector<uint32_t> m_outputs {3};
    std::vector<int32_t> m_dim {1, 2, 2, 1};
};

void ScatterNDBuilderTest::SetUp() {}

void ScatterNDBuilderTest::TearDown() {}

/**
 * @tc.name: scatterNd_build_001
 * @tc.desc: Verify that the build function returns a successful message.
 * @tc.type: FUNC
 */
HWTEST_F(ScatterNDBuilderTest, scatterNd_build_001, TestSize.Level1)
{
...
/**
 * @tc.name: scatterNd_build_002
 * @tc.desc: Verify that the build function returns a failed message with true m_isBuild.
 * @tc.type: FUNC
 */
HWTEST_F(ScatterNDBuilderTest, scatterNd_build_002, TestSize.Level1)
{
    SaveInputTensor(m_inputs, OH_NN_INT32, m_dim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_INT32, m_dim, nullptr);
...
/**
 * @tc.name: scatterNd_build_003
 * @tc.desc: Verify that the build function returns a failed message with invalided input.
 * @tc.type: FUNC
 */
HWTEST_F(ScatterNDBuilderTest, scatterNd_build_003, TestSize.Level1)
{
    m_inputs = {0, 1, 2, 3};
    m_outputs = {4};
...
/**
 * @tc.name: scatterNd_build_004
 * @tc.desc: Verify that the build function returns a failed message with invalided output.
 * @tc.type: FUNC
 */
HWTEST_F(ScatterNDBuilderTest, scatterNd_build_004, TestSize.Level1)
{
    m_outputs = {3, 4};
...
/**
 * @tc.name: scatterNd_build_005
 * @tc.desc: Verify that the build function returns a failed message with empty allTensor.
 * @tc.type: FUNC
 */
HWTEST_F(ScatterNDBuilderTest, scatterNd_build_005, TestSize.Level1)
{
...
/**
 * @tc.name: scatterNd_build_006
 * @tc.desc: Verify that the build function returns a failed message without output tensor.
 * @tc.type: FUNC
 */
HWTEST_F(ScatterNDBuilderTest, scatterNd_build_006, TestSize.Level1)
{
    SaveInputTensor(m_inputs, OH_NN_INT32, m_dim, nullptr);
...
/**
 * @tc.name: scatterNd_getprimitive_001
 * @tc.desc: Verify that the getPrimitive function returns a successful message
 * @tc.type: FUNC
 */
HWTEST_F(ScatterNDBuilderTest, scatterNd_getprimitive_001, TestSize.Level1)
{
    SaveInputTensor(m_inputs, OH_NN_INT32, m_dim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_INT32, m_dim, nullptr);
...
/**
 * @tc.name: scatterNd_getprimitive_002
 * @tc.desc: Verify that the getPrimitive function returns a failed message without build.
 * @tc.type: FUNC
 */
HWTEST_F(ScatterNDBuilderTest, scatterNd_getprimitive_002, TestSize.Level1)
{
    LiteGraphPrimitvePtr primitive = m_builder.GetPrimitive();
    LiteGraphPrimitvePtr expectPrimitive(nullptr, DestroyLiteGraphPrimitive);
