...
#include "ops/reciprocal_builder.h"
...
namespace UnitTest {
class ReciprocalBuilderTest : public OpsTest {
public:
    void SetUp() override;
    void TearDown() override;

protected:
    ReciprocalBuilder m_builder;
    std::vector<uint32_t> m_inputs {0};
    std::vector<uint32_t> m_outputs {1};
    std::vector<int32_t> m_dim {1, 2, 2, 1};
};

void ReciprocalBuilderTest::SetUp() {}

void ReciprocalBuilderTest::TearDown() {}

/**
 * @tc.name: reciprocal_build_001
...
/**
 * @tc.name: reciprocal_getprimitive_001
...
/**
 * @tc.name: reciprocal_getprimitive_002
