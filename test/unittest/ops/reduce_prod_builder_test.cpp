...
#include "frameworks/native/ops/reduceprod_builder.h"
...
void ReduceProdBuilderTest::SaveParamsTensor(OH_NN_DataType dataType,
    const std::vector<int32_t> &dim, const OH_NN_QuantParam* quantParam, OH_NN_TensorType type)
{
...
HWTEST_F(ReduceProdBuilderTest, reduceprod_build_001, TestSize.Level0)
{
    ...
    SaveParamsTensor(OH_NN_BOOL, m_paramDim, nullptr, OH_NN_REDUCE_PROD_KEEP_DIMS);
...
HWTEST_F(ReduceProdBuilderTest, reduceprod_get_primitive_002, TestSize.Level0)
{
    ...
    auto returnValue = mindspore::lite::MindIR_ReduceFusion_GetKeepDims(reduceprodPrimitive.get());
