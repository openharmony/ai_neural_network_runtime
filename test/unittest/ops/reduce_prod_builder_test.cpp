...
#include "ops/reduceprod_builder.h"
...
namespace UnitTest {
class ReduceProdBuilderTest : public OpsTest {
public:
    void SetUp() override;
...
protected:
    ReduceProdBuilder m_builder;
    std::vector<uint32_t> m_inputs {0, 1};
    std::vector<uint32_t> m_outputs {2};
    std::vector<uint32_t> m_params {3, 4, 5};
    std::vector<int32_t> m_inputDim {3, 5, 6, 4};
    std::vector<int32_t> m_outputDim {3, 5, 6, 1};
    std::vector<int32_t> m_paramDim {1};
};

void ReduceProdBuilderTest::SetUp() {}

void ReduceProdBuilderTest::TearDown() {}

void ReduceProdBuilderTest::SetKeepDims(OH_NN_DataType dataType,
    const std::vector<int32_t> &dim, const OH_NN_QuantParam* quantParam, OH_NN_TensorType type)
{
...
void ReduceProdBuilderTest::SetCoeff(OH_NN_DataType dataType,
    const std::vector<int32_t> &dim, const OH_NN_QuantParam* quantParam, OH_NN_TensorType type)
{
...
void ReduceProdBuilderTest::SetReduceToEnd(OH_NN_DataType dataType,
    const std::vector<int32_t> &dim, const OH_NN_QuantParam* quantParam, OH_NN_TensorType type)
{
...
/**
 * @tc.name: reduceprod_build_002
 * @tc.desc: Call Build func twice to verify the abnormal behavior of the Build function
 * @tc.type: FUNC
 */
HWTEST_F(ReduceProdBuilderTest, reduceprod_build_002, TestSize.Level0)
{
    SaveInputTensor(m_inputs, OH_NN_BOOL, m_inputDim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_BOOL, m_outputDim, nullptr);
    SetKeepDims(OH_NN_BOOL, m_paramDim, nullptr, OH_NN_REDUCE_PROD_KEEP_DIMS);
...
/**
 * @tc.name: reduceprod_build_005
 * @tc.desc: Verify that the build function return a failed message with null allTensor
 * @tc.type: FUNC
 */
HWTEST_F(ReduceProdBuilderTest, reduceprod_build_005, TestSize.Level0)
{
...
/**
 * @tc.name: reduceprod_build_006
 * @tc.desc: Verify that the build function return a failed message without output tensor
 * @tc.type: FUNC
 */
HWTEST_F(ReduceProdBuilderTest, reduceprod_build_006, TestSize.Level0)
{
    SaveInputTensor(m_inputs, OH_NN_BOOL, m_inputDim, nullptr);
...
/**
 * @tc.name: reduceprod_build_008
 * @tc.desc: Verify that the build function return a failed message with invalided coeff's dataType
 * @tc.type: FUNC
 */
HWTEST_F(ReduceProdBuilderTest, reduceprod_build_008, TestSize.Level0)
{
    SaveInputTensor(m_inputs, OH_NN_BOOL, m_inputDim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_BOOL, m_outputDim, nullptr);
...
HWTEST_F(ReduceProdBuilderTest, reduceprod_build_009, TestSize.Level0)
{
    ...
    std::shared_ptr<NNTensor> reduceToEndTensor = TransToNNTensor(OH_NN_INT64,
        m_paramDim, nullptr, OH_NN_REDUCE_PROD_REDUCE_TO_END);
...
/**
 * @tc.name: reduceprod_build_013
 * @tc.desc: Verify that the build function return a failed message with invalided parameter
 * @tc.type: FUNC
 */
HWTEST_F(ReduceProdBuilderTest, reduceprod_build_013, TestSize.Level0)
{
    SaveInputTensor(m_inputs, OH_NN_BOOL, m_inputDim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_BOOL, m_outputDim, nullptr);
...
/**
 * @tc.name: reduceprod_build_014
 * @tc.desc: Verify that the build function return a failed message with invalided coeff parameter
 * @tc.type: FUNC
 */
HWTEST_F(ReduceProdBuilderTest, reduceprod_build_014, TestSize.Level0)
{
    SaveInputTensor(m_inputs, OH_NN_BOOL, m_inputDim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_BOOL, m_outputDim, nullptr);
    SetKeepDims(OH_NN_BOOL, m_paramDim, nullptr, OH_NN_REDUCE_PROD_KEEP_DIMS);
...
/**
 * @tc.name: reduceprod_build_016
 * @tc.desc: Verify that the build function return a failed message with empty keepdims's buffer
 * @tc.type: FUNC
 */
HWTEST_F(ReduceProdBuilderTest, reduceprod_build_016, TestSize.Level0)
{
    SaveInputTensor(m_inputs, OH_NN_BOOL, m_inputDim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_BOOL, m_outputDim, nullptr);
...
/**
 * @tc.name: reduceprod_build_017
 * @tc.desc: Verify that the build function return a failed message with empty coeff's buffer
 * @tc.type: FUNC
 */
HWTEST_F(ReduceProdBuilderTest, reduceprod_build_017, TestSize.Level0)
{
    SaveInputTensor(m_inputs, OH_NN_BOOL, m_inputDim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_BOOL, m_outputDim, nullptr);
...
/**
 * @tc.name: reduceprod_build_018
 * @tc.desc: Verify that the build function return a failed message with empty reduceToEnd's buffer
 * @tc.type: FUNC
 */
HWTEST_F(ReduceProdBuilderTest, reduceprod_build_018, TestSize.Level0)
{
    SaveInputTensor(m_inputs, OH_NN_BOOL, m_inputDim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_BOOL, m_outputDim, nullptr);
...
/**
 * @tc.name: reduceprod_get_primitive_001
 * @tc.desc: Verify the GetPrimitive function return nullptr
 * @tc.type: FUNC
 */
HWTEST_F(ReduceProdBuilderTest, reduceprod_get_primitive_001, TestSize.Level0)
{
...
/**
 * @tc.name: reduceprod_get_primitive_002
 * @tc.desc: Verify the normal params return behavior of the getprimitive function
 * @tc.type: FUNC
 */
HWTEST_F(ReduceProdBuilderTest, reduceprod_get_primitive_002, TestSize.Level0)
{
    SaveInputTensor(m_inputs, OH_NN_BOOL, m_inputDim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_BOOL, m_outputDim, nullptr);
    SetKeepDims(OH_NN_BOOL, m_paramDim, nullptr, OH_NN_REDUCE_PROD_KEEP_DIMS);
    ...
    EXPECT_EQ(OH_NN_SUCCESS, m_builder.Build(m_params, m_inputsIndex, m_outputsIndex, m_allTensors));
    LiteGraphTensorPtr reduceprodPrimitive = m_builder.GetPrimitive();
    LiteGraphTensorPtr expectPrimitive = {nullptr, DestroyLiteGraphPrimitive};

    EXPECT_NE(reduceprodPrimitive, expectPrimitive);
    auto returnKeepDimsValue = mindspore::lite::MindIR_ReduceFusion_GetKeepDims(reduceprodPrimitive.get());
    EXPECT_EQ(returnKeepDimsValue, keepDimsValue);
    auto returnCoeffValue = mindspore::lite::MindIR_ReduceFusion_GetCoeff(reduceprodPrimitive.get());
    EXPECT_EQ(returnCoeffValue, coeffValue);
    auto returnReduceToEndValue = mindspore::lite::MindIR_ReduceFusion_GetReduceToEnd(reduceprodPrimitive.get());
