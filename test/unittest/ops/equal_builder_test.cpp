...
namespace UnitTest {
class EqualBuilderTest : public OpsTest {
public:
    void SetUp() override;
    void TearDown() override;

protected:
    EqualBuilder m_builder;
...
void EqualBuilderTest::SetUp() {}

void EqualBuilderTest::TearDown() {}

/**
 * @tc.name: equal_build_001
 * @tc.desc: Verify that the build function returns a successful message.
 * @tc.type: FUNC
 */
HWTEST_F(EqualBuilderTest, equal_build_001, TestSize.Level1)
{
...
/**
 * @tc.name: equal_getprimitive_001
 * @tc.desc: Verify that the getPrimitive function returns a successful message
 * @tc.type: FUNC
 */
HWTEST_F(EqualBuilderTest, equal_getprimitive_001, TestSize.Level1)
{
    SaveInputTensor(m_inputs, OH_NN_INT32, m_inputDim, nullptr);
    SaveOutputTensor(m_outputs, OH_NN_BOOL, m_outputDim, nullptr);
...
/**
 * @tc.name: equal_getprimitive_002
 * @tc.desc: Verify that the getPrimitive function returns a failed message without build.
 * @tc.type: FUNC
 */
HWTEST_F(EqualBuilderTest, equal_getprimitive_002, TestSize.Level1)
{
    LiteGraphPrimitvePtr primitive = m_builder.GetPrimitive();
    LiteGraphPrimitvePtr expectPrimitive(nullptr, DestroyLiteGraphPrimitive);
