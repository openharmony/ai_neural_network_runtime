...
#include "frameworks/native/ops/sqrt_builder.h"
...
namespace UnitTest {
class SqrtBuilderTest : public OpsTest {
protected:
...
protected:
    SqrtBuilder m_builder;
};

void SqrtBuilderTest::InitTensor(const std::vector<uint32_t>& inputsIndex,
...
void SqrtBuilderTest::CheckResult()
{
...
/**
 * @tc.name: sqrt_build_003
 * @tc.desc: Provide one more than normal input to verify the abnormal behavior of the Build function
 * @tc.type: FUNC
 */
HWTEST_F(SqrtBuilderTest, sqrt_build_003, TestSize.Level0)
{
...
/**
 * @tc.name: sqrt_build_007
 * @tc.desc: Provide a param to verify the abnormal behavior of the Build function
 * @tc.type: FUNC
 */
HWTEST_F(SqrtBuilderTest, sqrt_build_007, TestSize.Level0)
{
    std::vector<uint32_t> inputsIndex = { 0 };
    std::vector<uint32_t> outputsIndex = { 1 };
...
/**
 * @tc.name: sqrt_getprimitive_001
 * @tc.desc: Verify the GetPrimitive function return nullptr
 * @tc.type: FUNC
 */
HWTEST_F(SqrtBuilderTest, sqrt_getprimitive_001, TestSize.Level0)
{
    LiteGraphTensorPtr primitive = m_builder.GetPrimitive();
    LiteGraphTensorPtr expectPrimitive(nullptr, DestroyLiteGraphPrimitive);
...
/**
 * @tc.name: sqrt_getprimitive_002
 * @tc.desc: Verify the normal params return behavior of the getprimitive function
 * @tc.type: FUNC
 */
HWTEST_F(SqrtBuilderTest, sqrt_getprimitive_002, TestSize.Level0)
{
    std::vector<uint32_t> inputsIndex = { 0 };
    std::vector<uint32_t> outputsIndex = { 1 };
    InitTensor(inputsIndex, outputsIndex);
