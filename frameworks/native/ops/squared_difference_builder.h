...
#define NEURAL_NETWORK_RUNTIME_SQUAREDDIFFERENCE_BUILDER_H
...
namespace Ops {
class SquaredDifferenceBuilder : public OpsBuilder {
public:
    SquaredDifferenceBuilder();
    ~SquaredDifferenceBuilder() override;
...
#endif // NEURAL_NETWORK_RUNTIME_SQUAREDDIFFERENCE_BUILDER_H