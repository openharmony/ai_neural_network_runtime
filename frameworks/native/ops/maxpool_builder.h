...
#ifndef NEURAL_NETWORK_RUNTIME_MAXPOOL_BUILDER_H
...
namespace Ops {
class MaxPoolBuilder : public PoolingBuilder {
public:
    MaxPoolBuilder();
    ~MaxPoolBuilder() override;
...
#endif // NEURAL_NETWORK_RUNTIME_MAXPOOL_BUILDER_H
