...
OH_NN_ReturnCode HDIPreparedModelV2_0::GetModelID(uint32_t& modelId) const
{
    LOGE("hdi preparedModel V2_0 not support get model ID.");
    return OH_NN_SUCCESS;
}

OH_NN_ReturnCode HDIPreparedModelV2_0::ReleaseBuiltModel()
{
    LOGE("hdi preparedModel V2_0 not support ReleaseBuiltModel.");
    return OH_NN_SUCCESS;
}

OH_NN_ReturnCode HDIPreparedModelV2_0::SetAippString(const std::string& aippStrings)
{
    LOGE("hdi preparedModel V2_0 not support SetAippString.");
    return OH_NN_SUCCESS;
}
} // namespace NeuralNetworkRuntime
} // OHOS
