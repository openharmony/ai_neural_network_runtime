...
#ifndef NEURAL_NETWORK_RUNTIME_STACK_BUILDER_H
#define NEURAL_NETWORK_RUNTIME_STACK_BUILDER_H
...
public:
    typedef OH_NN_ReturnCode(StackBuilder::*FuncPtr)(std::shared_ptr<NNTensor>);
...
#endif // NEURAL_NETWORK_RUNTIME_STACK_BUILDER_H