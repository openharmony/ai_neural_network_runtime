...
#ifndef NEURAL_NETWORK_RUNTIME_REDUCEMIN_BUILDER_H
#define NEURAL_NETWORK_RUNTIME_REDUCEMIN_BUILDER_H
...
private:
    ...
    std::unordered_map<OH_NN_TensorType, FuncPtr> m_paramMap = {
        {OH_NN_REDUCE_MIN_COEFF, &ReduceMinBuilder::SetCoeff},
        {OH_NN_REDUCE_MIN_REDUCE_TO_END, &ReduceMinBuilder::SetReduceToEnd},
        {OH_NN_REDUCE_MIN_KEEP_DIMS, &ReduceMinBuilder::SetKeepDims}
    };
};
} // namespace Ops
} // namespace NeuralNetworkRuntime
...
#endif // NEURAL_NETWORK_RUNTIME_REDUCEMIN_BUILDER_H