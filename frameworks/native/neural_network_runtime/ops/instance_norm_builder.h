...
#ifndef NEURAL_NETWORK_RUNTIME_INSTANCE_NORM_BUILDER_H
#define NEURAL_NETWORK_RUNTIME_INSTANCE_NORM_BUILDER_H
...
#endif // NEURAL_NETWORK_RUNTIME_INSTANCE_NORM_BUILDER_H