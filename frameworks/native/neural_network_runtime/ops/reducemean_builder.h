...
#ifndef NEURAL_NETWORK_RUNTIME_REDUCEMEAN_BUILDER_H
#define NEURAL_NETWORK_RUNTIME_REDUCEMEAN_BUILDER_H
...
public:
    typedef OH_NN_ReturnCode (ReduceMeanBuilder::*FuncPtr)(const std::shared_ptr<NNTensor>&);
...
#endif // NEURAL_NETWORK_RUNTIME_REDUCEMEAN_BUILDER_H