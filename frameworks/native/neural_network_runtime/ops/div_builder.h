...
#ifndef NEURAL_NETWORK_RUNTIME_DIV_BUILDER_H
#define NEURAL_NETWORK_RUNTIME_DIV_BUILDER_H
...
public:
    typedef OH_NN_ReturnCode(DivBuilder::*FuncPtr)(std::shared_ptr<NNTensor>);
...
#endif // NEURAL_NETWORK_RUNTIME_DIV_BUILDER_H